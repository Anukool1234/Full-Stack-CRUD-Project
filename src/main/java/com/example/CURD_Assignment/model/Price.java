...
public class Price {
	...
	public Price(String productMasterUID, int regularPrice, int currentPrice) {
		super();
		this.productMasterUID = productMasterUID;
		this.regularPrice = regularPrice;
		this.currentPrice = currentPrice;
	...
	public String toString() {
		return "Price [productMasterUID=" + productMasterUID + ", regularPrice=" + regularPrice + ", currentPrice="
				+ currentPrice + "]";
	}
