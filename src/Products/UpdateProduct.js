    ...
    <div className="container">
      <div className="row">
        <div className="col-md-6 offset-md-3 border roundeed p-4 mt-2 shadow">
          <h2 className="text-center m-4" style={{fontSize:40}}>Update Products</h2>
                        ...
                        taxationObj.taxes.map((taxesObject, taxesIndex) => {
                          return (
                            <div  key={taxesObject.name + taxesIndex}>
                              ...
                              <input className="mx-2" id="name" name="name" required type="text" placeholder="Enter Tax Name"
                                value={taxesObject.name}
                                onChange={(e) => { handleTaxesChange(taxationIndex, taxesIndex, e) }} />
                             
                              <label htmlFor="values"> Value: </label>
                             
                              <input className="mx-2" id="displayName" name="value" required type="text" placeholder="Enter Tax Value"
